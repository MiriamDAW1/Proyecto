...
public class ControladoraModificarEmpresa {
	    ...
	    public void setEmpresa(Empresa empresa) {
	        ...
	        ID_ConvenioTextField.setText(empresa.getID_Convenio());
	        NombreTextField.setText(empresa.getNombre());
	        ProvinciaTextField.setText(empresa.getProvincia());
	        CIFTextField.setText(empresa.getCIF());
	        PaisTextField.setText(empresa.getPais());
	        CiudadTextField.setText(empresa.getCiudad());
	        DireccionTextField.setText(empresa.getDireccion());
	        CPTextField.setText(empresa.getCP());
	        TelefonoTextField.setText(empresa.getTelefono());
	        FaxTextField.setText(empresa.getFax());
	        Fecha_firmaTextField.setText(empresa.getFecha_firma());
	    ...
	    private void guardar() {
	        ...
	        if (datosValidos()) {
	            ...
	            try {
					conexionBBDD.ModificarEmpresa(ID_ConvenioTextField.getText(), NombreTextField.getText(), ProvinciaTextField.getText(), CIFTextField.getText(), PaisTextField.getText(), CiudadTextField.getText(), DireccionTextField.getText(), CPTextField.getText(), TelefonoTextField.getText(), FaxTextField.getText(), Fecha_firmaTextField.getText());
