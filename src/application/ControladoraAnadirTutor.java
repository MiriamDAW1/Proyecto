...
public class ControladoraAnadirTutor {
    ...
    private void guardar() {
        ...
        if (datosValidos()) {
            ...
            try {
				conexionBBDD.InsertarTutor(DNI_TutorTextField.getText(), TelefonoTextField.getText(), NacionalidadTextField.getText(), ApellidoTextField.getText(), NombreTextField.getText(), ProvinciaTextField.getText(), LocalidadTextField.getText(), Correo_electronicoTextField.getText(), ID_ConvenioTextField.getText());
